...
namespace System
{
    ...
    {
		// TODO
        private static OperatingSystem GetOSVersion() => GetOperatingSystem("2.0.0.1");
        ...
        private static OperatingSystem GetOperatingSystem(string release)
        {
            ...
            return new OperatingSystem(PlatformID.Other, new Version(major, minor, build, revision));
        }
